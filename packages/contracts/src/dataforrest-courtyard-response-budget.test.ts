...
test("Courtyard response budget is isolated in a new immutable 100-record profile", () => {
  ...
  for (const historical of dataforrestEventsV1SourceAdapterManifests.filter((candidate) => candidate !== manifest)) {
