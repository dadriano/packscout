-- Keep durable protected page evidence aligned with the largest registered
-- launch adapter bound. DataForrest V1 and V2 retain their narrower transport
-- limits; this table-level envelope admits V3 pages up to 8 MiB.
