...
const localAuditEvidenceKeys = new Set([
  ...
  "catalogCensusVersion", "catalogPageResponseDigest", "catalogRawCardCount",
  "catalogRawPackCount", "catalogDistinctCardCount", "catalogDistinctPackCount",
  "catalogIdentityChainDigest", "catalogPageIdentityMultisetDigest",
