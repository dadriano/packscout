...
export const CONVEX_APP_TABLES = Object.freeze([
  ...
  "activeCollectibleProfileHeads",
  "activeDataReleaseV3State",
  "activePackHeads",
  "activeProviderProfileHeads",
  ...
  "dataReleaseV3EvFactSets",
  "dataReleaseV3EvFacts",
  ...
  "publicPackMemberships",
  "publicPackSnapshotBatchDependencies",
  "publicPackSnapshotBatches",
  "publicPackSnapshots",
