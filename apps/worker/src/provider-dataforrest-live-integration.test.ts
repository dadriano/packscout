...
test("adapter profiles never resolve across provider boundaries", () => {
  ...
  const profiles = [
    ...
    // The all-stream pack-reading profiles production can actually activate.
    {
      providerKey: "courtyard" as const,
      adapterKey: DATAFORREST_COURTYARD_DISTRIBUTED_ADAPTER_V3_VERSION,
    },
    {
      providerKey: "collector_crypt" as const,
      adapterKey: DATAFORREST_COLLECTOR_CRYPT_DISTRIBUTED_ADAPTER_V3_VERSION,
    },
    {
      providerKey: "phygitals" as const,
