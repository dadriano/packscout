...
const sourceCodes = new Set([
  ...
  ...[
    "ABORTED", "AUTHORITY_INVALID", "AUTHORITY_UNAVAILABLE",
    "CATALOG_RESTART_UNSUPPORTED", "CURSOR_INVALID", "PAGE_INVALID",
    "RESPONSE_INVALID", "TERMINALIZATION_FAILED", "TRANSLATION_INVALID",
