...
export const ALL_REPACKS_HEADERS: readonly AllRepacksHeader[] = Object.freeze([
  ...
  { key: "evDollars", label: "PackScout EV $", sort: "packscout_ev_dollars" },
  { key: "evPercent", label: "PackScout EV %", sort: "packscout_ev_percent" },
  ...
  { key: "grossEv", label: "PackScout Gross EV", sort: "packscout_gross_ev" },
