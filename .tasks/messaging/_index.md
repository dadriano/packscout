...
|---|---|---|---|---|
| 001 | Establish the message delivery boundary and provider adapters | medium | in_progress | none |
...
| ID | Task | Scope | Status | Depends on |
|---|---|---|---|---|
| 005 | Route operational alerts to operators by email | medium | todo | 003, 004 |
...
| ID | Task | Scope | Status | Depends on |
|---|---|---|---|---|
| 008 | Issue and redeem one-time email links | large | todo | 003, 004 |
