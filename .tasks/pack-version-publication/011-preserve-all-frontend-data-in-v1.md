...
Capacity choice requested18:33UTC September5 and awaiting user response: retain actual current catalog bounds1,000packs/512categories, or implement the proposed8,000-pack catalog with a different lossless bounded query layout. Both preserve every existing frontend feature/datapoint and full contents up to8,000 members per individual pack. No reduction is approved yet. Continue the independent003/004 foundation fixes while awaiting this choice; do not confuse catalog capacity with per-pack membership or claim8k is impossible under every architecture.
