...
Current review repairs are frozen: P03 runtime8f2a4d84, published7ab81375, adds explicit cookie-auth context with126 complete tests0skip; full local/CI and fresh review are running, and the cookie thread is replied/resolved. P04 runtime63ac7101 fixes terminal blocked profile jobs, complete NFC normalization and cookies, with103 complete tests0skip. Affected static checks pass; independent147 cookie+1,538 prior probes per guard,34 NFC controls and bounded outbox review are green. P04 publication/current-runtime full certification and its two fixing-SHA replies remain. Earlier published-head successes certify only their older runtimes. No activation occurred.
