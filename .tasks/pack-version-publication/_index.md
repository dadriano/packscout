...
Current review repairs are committed: P03 runtime29c2e26d and P04 runtimeaa6a7c3c add contextual key/value DSN detection and standard PGP private-key armor protection. Complete focused matrices pass130/130 and106/106 with zero skips; affected static checks and ratchet0 pass. Independent580-probe review found no new defect:563 initial expectations matched,13 P04 nested-caption refusals match the exact pre-change baseline, and4 P03 raw NFC differences are covered by actual final-assembly rejection. Both previous published heads7ab81375/fbafabde passed full CI33983263719/33983598401, but those passes do not certify the new source. P03 also passed its previous cookie full local gate; P04's previous local gate was intentionally stopped143 for propagation. Fresh publication/full certification and114's two fixing-SHA replies remain. No activation occurred.
