...
Turn `stadium_vault.json` and `trove.json` into sanitized contract fixtures and document how each provider's probability tiers, value bounds, price, and cards-per-pack semantics map into EV inputs.
