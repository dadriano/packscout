...
Create canonical examples for a linked pull, an unlinked pull, a USD sale, a transfer with no amount, and a provider-specific event whose type is not one of PackScout's known categories.
