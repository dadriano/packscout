...
> **Superseded implementation artifact (2026-08-14).** This aggregate `sales` task is historical evidence only; do not build it. Use the current [record-stream V2 contract](../../docs/provider-data-contract-v2.md) and its mixed `catalog`/`pulls`/`trades` mapper boundary.
